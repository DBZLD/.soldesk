...
public class Common {
	//상수를 모아놓은 클래스
	public static final String API_KEY = "RGAPI-7cd9e285-1f22-4e06-9e42-d895733d5bef"; //라이엇 API 키(API 접속 시 필요)
	public static final String REGIONS = "ko_KR";						//지역(API 접속 시 필요)
	
	public static final Integer MATCH_COUNT = 5;						//API로 가져올 매치 수
	
	public static final String CHAMPIONS_URL = "tft-champion";			//이미지URL 종류(챔피언)
