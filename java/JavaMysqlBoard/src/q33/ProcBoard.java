...
public class ProcBoard {
	...
	void run() {
		...
		String stTitle = sc.next();
		
		dbExecuteUpdate(String.format("insert into board (b_title,b_id,b_datetime,b_text,b_hit) values ('%s','kitty',now(),'콘솔프로그램에서 작성한 글입니다. 글글.....글....',0)", stTitle));
